    ...
    function acertou(obj) {
      ...
      img.src = "https://i.pinimg.com/474x/e6/b2/71/e6b271792a254c6ed907bb28b169efbb.jpg";
    ...
    function verifica(obj) {
      ...
      if (jogar) {
        ...
        if (obj.id == sorteado) {
          ...
          // cria uma imagem para mostrar quando o jogador erra
          const imgErro = new Image(20); // Define o tamanho da imagem
          imgErro.id = "imagemErro";
          // define o atributo src da imagem como o link fornecido
          imgErro.src = "https://pbs.twimg.com/tweet_video_thumb/Dxg1FYNX0AAGlND.jpg";
          // adiciona a imagem à div escolhida pelo jogador
